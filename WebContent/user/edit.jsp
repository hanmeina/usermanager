...
<HTML>
	...
	<body>
		<s:form id="userAction_save_do" name="Form1" action="UserAction_editUser" namespace="/" method="post" enctype="multipart/form-data" theme="simple">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" >
						...
						<s:password  name="loginpass"  id="loginpass" showPassword="true"></s:password>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						用户姓名：
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						...
						<s:select list="{'本科','专科','高中'}" name="education" id="education" headerKey="" headerValue="--选择学历--"></s:select>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						  <s:textfield name="cellphone" id="cellphone"></s:textfield>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						   <s:checkboxlist list="{'看电影','旅游','健身','购物','睡觉'}" name="hobby" id="hobby" value="hobbyList" ></s:checkboxlist>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<s:file name="upload2" size="30" id="userAction_save_do_upload" value=""></s:file>
					</td>
				</tr>
				<TR>
