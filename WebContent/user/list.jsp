...
<HTML>
	...
	<body>
		<br>
		<s:form id="Form1" name="Form1" action="UserAction_list" method="post" namespace="/" theme="simple">
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff">					 
									    <s:textfield name="username" id="Form1_username" cssClass="bg" size="15" ></s:textfield>
									</td>
									<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
										性别：
									</td>
								...
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff">
										<s:select list="#{'1':'有','2': '无'}" name="upload" id="upload"  headerKey="" headerValue="---请选择---">
										</s:select>
									</td>
								</tr>
								<tr>
